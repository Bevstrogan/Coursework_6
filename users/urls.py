...
from users.views import RegisterView, UserUpdateView, generate_new_password, UserListView, UserDetailView, \
...
urlpatterns = [
    ...
    path("view_user/<int:pk>/", UserDetailView.as_view(), name="user_view"),
